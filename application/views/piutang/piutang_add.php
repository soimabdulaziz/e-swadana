      ...
      <div class="row">
        ...
        <div class="box">
          ...
          <div class="pull-right">
            <a href="<?=site_url('Piutang')?>" class="btn btn-warning btn-flat ">
              ...
              <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <?php 
                      ...
                      if ($trs != "tarik") {
                        echo form_open('Piutang/tambah/'.$id_agt.'/'.$id.'');
                      } elseif ($trs == "tarik") {
                        echo form_open('Piutang/tarik/'.$id_agt.'/'.$id.'');
                      }
                    ...
                    <div class =" form-group <?=form_error('keterangan') ? 'has-error' : null?> ">
                            ...
                            <input type = "text" disabled name = "keterangan" <?php if ($this->uri->segment(5)=="tambah") { ?> value ="Pemasukan" <?php } elseif($this->uri->segment(5)=="tarik") { ?> value = "Pembayaran" <?php } ?> class= "form-control">
                            <span class="help-block"> <?=form_error('keeterangan')?> </span>
                    </div>
                    <?php if($id != "3") { ?>
                    <div class =" form-group <?=form_error('rupiah') ? 'has-error' : null?> ">
                            <label>Jumlah * </label>
                            <input type = "text" class="form-control money" placeholder="Masukan Nominal Piutang..." id = "rupiah" name = "rupiah"value= "" class= "form-control">
