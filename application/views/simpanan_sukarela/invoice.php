      ...
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <td><?php  
            ...
            <td></td>
            <?php if (@$d['status'] == "Pemasukan") { ?>
            <td>Pembayaran Simpanan Sukarela</td>
            <?php } else if (@$d['status'] == "Penarikan") { ?>
            <td>Tarik Tunai Simpanan Sukarela</td>
            <?php } ?>
          </tr>
          <tr>
            <th></th>
            <th></th>
            <th>Sisa Saldo Simpanan Wajib</th>
            <th><?php echo("Rp."); echo number_format((@$d['saldo_sukarela'])) ?></th>
          </tr>
          <tr>
            <td></td>
            <td></td>
