...
<h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Simpanan Sukarela</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="box">
          ...
          <div class="pull-right">
            <a href="<?=site_url('simpanan_sukarela')?>" class="btn btn-warning btn-flat ">
              ...
              <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <?php 
                      ...
                      if ($trs != "tarik") {
                        echo form_open('simpanan_sukarela/tambah/'.$id_agt.'/'.$id.'');
                      } elseif ($trs == "tarik") {
                        echo form_open('simpanan_sukarela/tarik/'.$id_agt.'/'.$id.'');
                      }
                    ...
                    <div class =" form-group <?=form_error('rupiah') ? 'has-error' : null?> ">
                            <label>Jumlah * </label>
                            <input type = "text" class="form-control money" placeholder="Masukan Nominal..." id = "rupiah"
                             name = "rupiah" value= "" class= "form-control" required>
